...
export function Host({ alojamiento }) {
  return (
    <div className="host mb-4 d-flex align-items-center">
      {/* <img
      ...
      <div className="host-avatar" style={{ display: "flex", alignItems: "center", justifyContent: "center", background: "#ddd" }}>
        <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="60%" height="60%" viewBox="0 0 973.000000 1280.000000" preserveAspectRatio="xMidYMid meet">
          <metadata>
      ...
      <div className="host-info ml-3">
        <div className="host-name">{alojamiento.anfitrion.nombre}</div>
        <div className="host-since text-muted">
          Miembro desde {dayjs(alojamiento.anfitrion.createdAt).format("MMMM YYYY")}
        </div>
      </div>
    </div>)
}